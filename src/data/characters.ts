...
// Shown on BeyondScreen only for an unrecognized characterId (the dev
// solo-preview flow) — Inspector and Associate route straight to their real
// destinations (Cellar/Library) from GameScreen instead of landing here.
